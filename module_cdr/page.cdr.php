...
function cdr_formatRecordingFile($recordingfile, $basename, $id, $uid) {
        ...
        if ($recordingfile) {
                ...
                $playbackRow = $id +1;
                //
                echo "<td title=\"$basename\"><a href=\"#\" onClick=\"javascript:cdr_play($playbackRow,'$download_url','$uid'); return false;\"><img src=\"assets/cdr/images/cdr_sound.png\" alt=\"Call recording\" /></a>
